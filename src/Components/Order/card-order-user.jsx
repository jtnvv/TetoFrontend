...
const CardOrderUser = (props) => {
    ...
    return (
        ...
        <div className="  min-w-max h-max text-white  ">

            

            <div className="flex   bg-[#646458] rounded px-10 py-3 h-max items-center space-x-5">
                    ...
                    <div className="mb-3 space-y-1  w-2/3 sm:1/3 ">
